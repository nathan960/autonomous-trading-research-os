...
---
## Outcome Tracker — 2026-05-25T22:09:18Z

**Run ID:** `outcome_tracker-20260525T220918-116f7da7`  **Outcomes tracked:** 14
...
---
## Outcome Tracker — 2026-05-25T22:18:59Z

**Run ID:** `outcome_tracker-20260525T221859-a21941d4`  **Outcomes tracked:** 14
...
```json
{
  ...
  "orders_ready": 1,
  "orders_validated": 1,
  "plan_id": "trade_plan-20260526T180707-ef99e66e",
  "run_id": "execution-20260526T180707-49e544fa",
  "status": "DRY_RUN_PASS",
  "trade_plan_hash": "7fc51d91de3f7bb4a01f9b8f008c2f9cad137e89b00fc764295e4e4b9a4e5d84"
}
```
...
{
  "dry_run": false,
  "generated_at": "2026-05-26T22:05:30Z",
  "lifecycles": [
    {
      "client_order_id": "TOS-20260513T160035-WELL-BUY",
      "fill": {
  ...
  "orders_rejected": 0,
  "orders_tracked": 14,
  "run_id": "order_monitor-20260526T220530-7e8eee82",
  "source": "alpaca_paper",
  "stale_orders": [],
  "warnings": []
}
...
{
  "dry_run": false,
  "generated_at": "2026-05-26T22:11:52Z",
  "lifecycles": [
    {
      "client_order_id": "TOS-20260513T160035-WELL-BUY",
      "fill": {
  ...
  "orders_rejected": 0,
  "orders_tracked": 14,
  "run_id": "order_monitor-20260526T221152-8901247a",
  "source": "alpaca_paper",
  "stale_orders": [],
  "warnings": []
}
...
```json
{
  ...
  "orders_ready": 1,
  "orders_validated": 1,
  "plan_id": "trade_plan-20260526T221152-f5a3f47e",
  "run_id": "execution-20260526T221152-7836405c",
  "status": "DRY_RUN_FAIL",
  "trade_plan_hash": "5dd7499809382afc0cea8fdd16f56e621467c71cf9b7aacb4f3c0b2e23ec69b9"
}
```
## Outcome Tracker — 2026-05-26T22:11:52Z

**Run ID:** `outcome_tracker-20260526T221152-8901247a`  **Outcomes tracked:** 14

- WELL BUY (entry) fill=$218.808 return=-0.310% unpl=$-0.0775 | pending: 20_trading_days, 63_trading_days
- JNJ BUY (entry) fill=$230.248 return=-0.078% unpl=$-0.0220 | pending: 20_trading_days, 63_trading_days
- EQIX BUY (entry) fill=$1084.37 return=-0.864% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- EQIX BUY (entry) fill=$1079.5 return=-0.417% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- EQIX SELL (exit) fill=$1078.442 return=-0.319% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- EQIX BUY (entry) fill=$1078.41 return=-0.316% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- JNJ BUY (entry) fill=$230.116 return=-0.021% unpl=$-0.0220 | pending: 20_trading_days, 63_trading_days
- WMT BUY (entry) fill=$132.276 return=-10.414% unpl=$-5.2402 | pending: 20_trading_days, 63_trading_days
- WMT BUY (entry) fill=$132.474 return=-10.547% unpl=$-5.2402 | pending: 20_trading_days, 63_trading_days
- EQIX BUY (entry) fill=$1076.89 return=-0.176% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- EQIX BUY (entry) fill=$1076.82 return=-0.169% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- JNJ BUY (entry) fill=$230.044 return=+0.011% unpl=$-0.0220 | pending: 20_trading_days, 63_trading_days
- EQIX SELL (exit) fill=$1076.718 return=-0.160% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days
- EQIX BUY (entry) fill=$1076.542 return=-0.143% unpl=$-0.2438 | pending: 20_trading_days, 63_trading_days

---
## Outcome Tracker — 2026-05-26T22:20:08Z

**Run ID:** `outcome_tracker-20260526T222008-5ccc60aa`  **Outcomes tracked:** 14
...
---
## Outcome Tracker — 2026-05-26T22:41:10Z

**Run ID:** `outcome_tracker-20260526T224110-79ebccdb`  **Outcomes tracked:** 14
...
```json
{
  ...
  "dry_run": true,
  "failed_gates": [],
  "generated_at": "2026-05-27T18:07:36Z",
  "no_submit_reason": "dry_run_mode",
  "orders_ready": 0,
  "orders_validated": 0,
  "plan_id": "trade_plan-20260527T180736-3e5531cc",
  "run_id": "execution-20260527T180736-0b329b14",
  "status": "DRY_RUN_PASS",
  "trade_plan_hash": "4060147969889380c0e97c4db97bf62ebf04d9a82518a729dbb36762cad4e928"
}
```
...
{
  "dry_run": false,
  "generated_at": "2026-05-27T22:16:55Z",
  "lifecycles": [
    {
      "client_order_id": "TOS-20260513T160035-WELL-BUY",
      "fill": {
  ...
  "orders_rejected": 0,
  "orders_tracked": 14,
  "run_id": "order_monitor-20260527T221655-442eeef8",
  "source": "alpaca_paper",
  "stale_orders": [],
  "warnings": []
}
